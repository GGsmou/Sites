const countFromDate = [
new Date("Sep 01, 2021 08:30:00").getTime(),
...
var x = setInterval(function() {
  ...
  for (var i = countFromDate.length - 1; i >= 0; i--) {
    ...
    document.getElementById(`ot-t${i+1}`).innerHTML = daysFrom + "d " + hoursFrom + "h " + minutesFrom + "m " + secondsFrom + "s ";
    ...
    while (distance<0) {
      var countDownDate = [
      new Date(`Sep 01, 202${d} 08:30:00`).getTime(),
    ...
    document.getElementById(`do-t${i+1}`).innerHTML = days + "d " + hours + "h " + minutes + "m " + seconds + "s ";
  }
}, 1000);